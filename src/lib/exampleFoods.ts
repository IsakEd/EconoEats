...
const exampleFoods: LanguageFoodMap = {
	...
	english: [
		...
		{
			name: 'pea/rice 7:3 protein powder',
			data: { price: 259.8, kcal: 380.21, carbs: 3.24, fat: 5.25, protein: 80 },
			suitable: { vegan: true, vegetarian: true, lactose: true, gluten: true },
			bounds: [0, 90],
			type: { dairy: false, vegetable: false, fruit: false, junk: true, grain: true }
		...
		{
			name: 'milk',
			data: { price: 0.99, kcal: 60, carbs: 5, fat: 3.5, protein: 3.3 },
			suitable: { vegan: false, vegetarian: true, lactose: true, gluten: false },
			bounds: [0, 500],
			type: { dairy: true, vegetable: false, fruit: false, junk: false, grain: false }
		},
		{
			name: 'apple',
			data: { price: 1.5, kcal: 52, carbs: 14, fat: 0.2, protein: 0.3 },
			suitable: { vegan: true, vegetarian: true, lactose: true, gluten: true },
			bounds: [0, 200],
			type: { dairy: false, vegetable: false, fruit: true, junk: false, grain: false }
		},
		{
			name: 'potato chips',
			data: { price: 2.99, kcal: 536, carbs: 52, fat: 35, protein: 6 },
			suitable: { vegan: true, vegetarian: true, lactose: true, gluten: true },
			bounds: [0, 150],
			type: { dairy: false, vegetable: false, fruit: false, junk: true, grain: false }
		},
		{
			name: 'brown rice',
			data: { price: 1.8, kcal: 111, carbs: 23, fat: 1.8, protein: 2.6 },
			suitable: { vegan: true, vegetarian: true, lactose: true, gluten: false },
			bounds: [0, 250],
			type: { dairy: false, vegetable: false, fruit: false, junk: false, grain: true }
		}
